...
public class FanGridPaneController implements Initializable {
	...
	public GridPane getFanGridPane() {
		...
		try {
			fanGridPane = FXMLLoader.load(Objects.requireNonNull(FanwiApplication.class.getResource("fxml/fan-block.fxml")));
			ImageView fanImageView = new ImageView(new Image(Objects.requireNonNull(FanwiApplication.class.getResourceAsStream("images/fan_icon1.png"))));
			...
			fanGridPane.getStylesheets().add(String.valueOf(FanwiApplication.class.getResource("stylesheet/fan-block.css")));
		} catch (IOException e) {
