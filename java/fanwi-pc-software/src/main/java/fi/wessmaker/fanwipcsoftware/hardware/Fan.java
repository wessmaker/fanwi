...
public class Fan {
	...
	private Fan(int speed, int offset, int realSpeed, int realOffset, boolean spinning, boolean tempControlled, boolean realSpinning, boolean realTempControlled) {
		this.speed = speed;
		this.offset = offset;
	...
	public static Fan getInstance(){
		if (fan == null){
			fan = new Fan(-1, -1, -1, -1, false, false, false, false);
	...
	//TODO make use of return keyword so that setters can return if they made it or not
