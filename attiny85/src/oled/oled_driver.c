...
const uint8_t TEMPERATURE_WORD[11][7] = {
   {0x7C, 0x42, 0x42, 0x42, 0x42, 0x42, 0x7C},  //T
   {0x42, 0x66, 0x66, 0x5A, 0x42, 0x42, 0x42},  //E
   {0x42, 0x66, 0x66, 0x5A, 0x42, 0x42, 0x42},  //M
   {0x7C, 0x42, 0x42, 0x7C, 0x42, 0x42, 0x7C},  //P
   {0x7C, 0x42, 0x42, 0x7C, 0x42, 0x42, 0x7C},  //E
   {0x7C, 0x42, 0x42, 0x42, 0x42, 0x42, 0x7C},  //R
   {0x7C, 0x40, 0x40, 0x7C, 0x40, 0x40, 0x7C},  //A
   {0x7C, 0x40, 0x40, 0x7C, 0x40, 0x40, 0x7C},  //T
   {0x42, 0x66, 0x66, 0x5A, 0x42, 0x42, 0x42},  //U
   {0x42, 0x66, 0x66, 0x5A, 0x42, 0x42, 0x42},  //R
   {0x7C, 0x42, 0x42, 0x7C, 0x42, 0x42, 0x7C}   //E
};
